            ...
            <div class="flex flex-col flex-1 gap-3">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                        <g fill="none">
                            <path fill="url(#SVGp2Ojne6g)" d="M24 13.5C24 19.299 19.299 24 13.5 24S3 19.299 3 13.5S7.7 3 13.5 3S24 7.701 24 13.5"/>
                            <path fill="url(#SVGYfXZQcuf)" d="M20.7 22.467A11.45 11.45 0 0 1 13.5 25C7.149 25 2 19.851 2 13.5S7.149 2 13.5 2S25 7.149 25 13.5c0 2.725-.948 5.229-2.532 7.2l6.167 6.166a1.25 1.25 0 0 1-1.768 1.768zm1.8-8.967a9 9 0 1 0-18 0a9 9 0 0 0 18 0"/>
                            <path fill="url(#SVGpcRDXdUD)" d="m28.74 12.656l-.919-.299a1.9 1.9 0 0 1-1.199-1.197l-.298-.918a.363.363 0 0 0-.684 0l-.299.918a1.89 1.89 0 0 1-1.18 1.197l-.919.299a.363.363 0 0 0 0 .684l.919.298a1.9 1.9 0 0 1 1.198 1.202l.299.918a.363.363 0 0 0 .684 0l.299-.918a1.89 1.89 0 0 1 1.198-1.197l.919-.299a.363.363 0 0 0 0-.684z"/>
                            <path fill="url(#SVGMo5KLbDs)" d="M18.775 7.837a3.5 3.5 0 0 0-1.647-1.168l-1.684-.546a.665.665 0 0 1 0-1.254l1.684-.547a3.47 3.47 0 0 0 2.15-2.154l.014-.042l.547-1.682a.665.665 0 0 1 1.255 0l.547 1.682a3.47 3.47 0 0 0 2.198 2.196l1.683.547l.034.008a.665.665 0 0 1 0 1.254l-1.684.547a3.47 3.47 0 0 0-2.197 2.196l-.548 1.682l-.016.042a.664.664 0 0 1-1.238-.042l-.548-1.682a3.5 3.5 0 0 0-.55-1.037"/>
                            <defs>
                                <linearGradient id="SVGYfXZQcuf" x1="3.421" x2="26.158" y1="26.158" y2="7.683" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#7c28b7"/><stop offset="1" stop-color="#ad84ca"/>
                                </linearGradient>
                            </defs>
                        </g>
                    </svg>
                    <input type="text" v-model="searchTerm" placeholder="Nombre o Nit de la Entidad.."
